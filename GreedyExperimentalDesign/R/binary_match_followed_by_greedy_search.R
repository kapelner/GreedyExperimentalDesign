...
#' @param ...					Arguments passed to \code{initGreedyExperimentalDesignObject}.
...
binaryMatchFollowedByGreedyExperimentalDesignSearch = function(X, compute_dist_matrix = NULL, ...){
	...
	greedy_design = initGreedyExperimentalDesignObject(Xdiffs, ...)
	...
	binary_then_greedy_experimental_design$greedy_design = greedy_design
...
#' @author Adam Kapelner
#' @export
resultsBinaryMatchThenGreedySearch = function(obj, num_vectors = 1000, compute_obj_vals = FALSE, form = "zero_one"){
