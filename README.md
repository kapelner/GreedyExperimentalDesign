...
If `R CMD INSTALL` fails with architecture mismatch errors (for example, "not a valid Win32 application"), remove stale compiled artifacts in the package `src/` directory and reinstall.
